...
This folder contains the Jupyter notebook implementation for the **Simple Csv Rag** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `simple_csv_rag.ipynb`
...
```bash
jupyter notebook simple_csv_rag.ipynb
```

or

```bash
jupyter lab simple_csv_rag.ipynb
```
