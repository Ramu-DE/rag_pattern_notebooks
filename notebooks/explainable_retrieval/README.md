...
This folder contains the Jupyter notebook implementation for the **Explainable Retrieval** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `explainable_retrieval.ipynb`
...
```bash
jupyter notebook explainable_retrieval.ipynb
```

or

```bash
jupyter lab explainable_retrieval.ipynb
```
