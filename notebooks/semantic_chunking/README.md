...
This folder contains the Jupyter notebook implementation for the **Semantic Chunking** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `semantic_chunking.ipynb`
...
```bash
jupyter lab semantic_chunking.ipynb
```
