# Graphrag With Milvus Vectordb

## Overview

This folder contains the Jupyter notebook implementation for the **Graphrag With Milvus Vectordb** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `graphrag_with_milvus_vectordb.ipynb`
...
```bash
jupyter notebook graphrag_with_milvus_vectordb.ipynb
```

or

```bash
jupyter lab graphrag_with_milvus_vectordb.ipynb
```
