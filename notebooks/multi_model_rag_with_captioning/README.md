...
This folder contains the Jupyter notebook implementation for the **Multi Model Rag With Captioning** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `multi_model_rag_with_captioning.ipynb`
...
```bash
jupyter notebook multi_model_rag_with_captioning.ipynb
```

or

```bash
jupyter lab multi_model_rag_with_captioning.ipynb
```
