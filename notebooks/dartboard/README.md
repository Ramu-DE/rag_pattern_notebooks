...
This folder contains the Jupyter notebook implementation for the **Dartboard** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `dartboard.ipynb`
...
```bash
jupyter notebook dartboard.ipynb
```

or

```bash
jupyter lab dartboard.ipynb
```
