...
This folder contains the Jupyter notebook implementation for the **Adaptive Retrieval** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `adaptive_retrieval.ipynb`
...
```bash
jupyter notebook adaptive_retrieval.ipynb
```

or

```bash
jupyter lab adaptive_retrieval.ipynb
```
