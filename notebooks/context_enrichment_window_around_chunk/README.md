# Context Enrichment Window Around Chunk

## Overview

This folder contains the Jupyter notebook implementation for the **Context Enrichment Window Around Chunk** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `context_enrichment_window_around_chunk.ipynb`
...
```bash
jupyter notebook context_enrichment_window_around_chunk.ipynb
```

or

```bash
jupyter lab context_enrichment_window_around_chunk.ipynb
```
