...
This folder contains the Jupyter notebook implementation for the **Contextual Chunk Headers** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `contextual_chunk_headers.ipynb`
...
```bash
jupyter notebook contextual_chunk_headers.ipynb
```

or

```bash
jupyter lab contextual_chunk_headers.ipynb
```
