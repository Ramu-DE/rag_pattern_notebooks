...
This folder contains the Jupyter notebook implementation for the **Relevant Segment Extraction** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `relevant_segment_extraction.ipynb`
...
```bash
jupyter notebook relevant_segment_extraction.ipynb
```

or

```bash
jupyter lab relevant_segment_extraction.ipynb
```
