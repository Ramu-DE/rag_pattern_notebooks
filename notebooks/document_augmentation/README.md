...
This folder contains the Jupyter notebook implementation for the **Document Augmentation** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `document_augmentation.ipynb`
...
```bash
jupyter notebook document_augmentation.ipynb
```

or

```bash
jupyter lab document_augmentation.ipynb
```
