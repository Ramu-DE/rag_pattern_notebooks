...
This folder contains the Jupyter notebook implementation for the **Fusion Retrieval With Llamaindex** RAG technique.

## Setup

1. Ensure you have configured the `.env` file in the project root with your API keys
2. Install required dependencies: `pip install -r ../../requirements.txt`
3. Open and run the notebook: `fusion_retrieval_with_llamaindex.ipynb`
...
```bash
jupyter notebook fusion_retrieval_with_llamaindex.ipynb
```

or

```bash
jupyter lab fusion_retrieval_with_llamaindex.ipynb
```
